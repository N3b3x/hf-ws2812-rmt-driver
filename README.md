...
This repository is an **ESP-IDF RMT backend**, not a portable CRTP chip
driver. `inc/` includes ESP-IDF headers on purpose. Other `hf-*-driver`
trees must not copy that pattern.
